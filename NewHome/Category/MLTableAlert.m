...
#define kMinAlertHeight      2*SCREEN_HEIGHT/3
#define kCancelButtonHeight   44.0
#define kCancelButtonMargin    0.0
#define kTitleLabelMargin     0.0
...
//	[self.alertBg addSubview:alertBgImage];
	...
	self.titleLabel.backgroundColor = PopView_TitleColor;
	self.titleLabel.textColor = [UIColor colorWithRed:92.0/255.0 green:170.0/255.0 blue:247.0/255.0 alpha:1];
//	self.titleLabel.shadowColor = [[UIColor blackColor] colorWithAlphaComponent:0.75];
	self.titleLabel.shadowOffset = CGSizeMake(0, -1);
	self.titleLabel.font = [UIFont boldSystemFontOfSize:18.0];
	self.titleLabel.frame = CGRectMake(kLateralInset, 15, kTableAlertWidth - kLateralInset * 2, kCancelButtonHeight);
...
//	[self.alertBg addSubview:maskShadow];
    ...
    [self.cancelButton setBackgroundImage:[UIImage imageNamed:@"未选中"] forState:UIControlStateNormal];
