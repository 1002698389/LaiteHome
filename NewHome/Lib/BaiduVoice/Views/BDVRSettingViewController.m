...
- (id)initWithStyle:(UITableViewStyle)style
{
	...
	if (self)
	{
        _propertyDic = [@{@10001 : @"音乐", @10002 : @"视频", @10003 : @"应用", @10004 : @"web", @10005 : @"热词", @10006 : @"电商购物",
                          @10007 : @"健康母婴", @10008 : @"打电话", @10052 : @"医疗", @10053 : @"汽车", @10054 : @"娱乐餐饮",
                          @10055 : @"财经", @10056 : @"游戏", @10057 : @"菜谱", @10058 : @"助手", @10059 : @"话费充值", @10060 : @"地图", @20000 : @"输入法"} retain];
